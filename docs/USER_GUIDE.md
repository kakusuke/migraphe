...
# Zip — Windows
curl -L -o migraphe.zip https://github.com/kakusuke/migraphe/releases/download/v0.4.1/migraphe-0.4.1.zip
unzip migraphe.zip -d ~/.local/migraphe
export PATH="$HOME/.local/migraphe/bin:$PATH"

# Fat JAR — single file
curl -L -o migraphe.jar https://github.com/kakusuke/migraphe/releases/download/v0.4.1/migraphe-0.4.1-all.jar
...
```kotlin
plugins {
    id("io.github.kakusuke.migraphe") version "v0.4.1"
}
...
dependencies {
    ...
    migraphePlugin("com.github.kakusuke.migraphe:migraphe-plugin-postgresql:v0.4.1")
    // migraphePlugin("com.github.kakusuke.migraphe:migraphe-plugin-mysql:v0.4.1")
    // migraphePlugin("com.github.kakusuke.migraphe:migraphe-plugin-jdbc:v0.4.1")
}
```
...
**Problem:**
```
Failed to resolve plugin: com.github.kakusuke.migraphe:migraphe-plugin-postgresql:v0.4.1
```

**Solution:**
- Check that the Maven coordinate and `repository:` reference in `migraphe.yaml` are correct
- Confirm the JitPack build of `v0.4.1` finished successfully at <https://jitpack.io/#kakusuke/migraphe>
...
Plugin JARs and the Gradle plugin are currently distributed via JitPack at `com.github.kakusuke.migraphe:<module>:v0.4.1`. Maven Central publication is planned; the groupId will switch to `io.github.kakusuke.migraphe` at that point.
